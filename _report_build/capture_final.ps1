...
function ClickFrac($hwnd,$fx,$fy){
  ...
  [Win]::SetForegroundWindow($hwnd)|Out-Null; Start-Sleep -Milliseconds 250
  [Win]::SetCursorPos($x,$y)|Out-Null; Start-Sleep -Milliseconds 250
  [Win]::mouse_event(0x0002,0,0,0,[UIntPtr]::Zero); Start-Sleep -Milliseconds 70
  [Win]::mouse_event(0x0004,0,0,0,[UIntPtr]::Zero)
  Write-Output "  click frac($fx,$fy)"
}
...
Capture $hwnd "$shots\final_3_charts.png"
